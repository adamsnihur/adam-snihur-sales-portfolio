...
```bash
jq '{requestedUrl, finalDisplayedUrl, accessibility: .categories.accessibility.score, failingWeightedAudits: ([.audits[] | select((.scoreDisplayMode == "binary" or .scoreDisplayMode == "numeric") and (.weight // 0) > 0 and (.score // 1) < 1)] | length)}' raporty/lighthouse-accessibility-2026-06-19.json raporty/lighthouse-accessibility-knowledge-2026-06-19.json raporty/lighthouse-accessibility-article-2026-06-19.json
```
